...
export COMMON_CFLAGS="-fPIC -fPIE -Oz -I$FAKE_USR/include -I$FREETYPE_PREFIX/include/freetype2 -I$TMX_PREFIX/include"
export COMMON_CXXFLAGS="-fPIC -fPIE -Oz -I$FAKE_USR/include -I$FREETYPE_PREFIX/include/freetype2 -I$TMX_PREFIX/include"
...
grep -n "Draw module is forced ON on Android by local patch" CMakeLists.txt || true
...
"$FAKE_USR/bin/drawenv" <<'EOF' || true
pload ALL
exit
EOF

echo "=== OpenCASCADE con parche Draw Android + Tcl/Tk + FreeType + FreeImage ==="
echo "Ejecuta asi:"
