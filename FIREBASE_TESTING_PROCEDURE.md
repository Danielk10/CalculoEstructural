...
3.  **Descargar logs:**
    ...
    ```
4.  **Diagnóstico:** Inspecciona el archivo `crash_log.txt` buscando la sección `FATAL EXCEPTION` para identificar `java.lang.UnsatisfiedLinkError`, `IllegalStateException`, etc.
